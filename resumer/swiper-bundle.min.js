;console.log('非源码,演示用的代码。源代码唯一下载地址: https://www.bootstrapmb.com/item/15674。（此备注只出现在演示站，下载的源码不包含。） ');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('mb')<0){location.href='https%3a%2f%2fwww.bootstrapmb.com%2fitem%2f15674'}}; /**
 * Swiper 8.2.2
